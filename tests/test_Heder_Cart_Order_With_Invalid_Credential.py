...
class TestPurchase(unittest.TestCase):
    ...
    def test_wrong_credentials(self):
        ...
        error_message = self.driver.find_element("//div[@class='sweet-alert showSweetAlert visible']/p") # locate the
        # error message
        self.assertEqual(error_message.text, "Please fill out Name and Creditcard.") # check if the error message is
        # correct
